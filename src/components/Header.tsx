      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center space-x-1">
            ...
            <Link
              to="/profile"
              className={`px-3.5 py-2 text-sm font-medium rounded-md transition-colors flex items-center gap-1.5 ${location.pathname === '/profile'
                ? 'text-amber-700 bg-amber-50/60'
                : 'text-slate-700 hover:text-slate-900 hover:bg-slate-50'
                }`}
            >
          ...
          <div className="hidden lg:flex items-center space-x-3">
            <Link
              to="/profile"
              className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-mono font-medium text-slate-700 hover:text-slate-900 rounded border border-slate-200 hover:border-slate-300 transition-colors bg-slate-50/70"
            >
              <User className="w-3.5 h-3.5 text-blue-600" />
          ...
          {/* Mobile Menu Button & Mobile Profile Link */}
          <div className="flex lg:hidden items-center gap-2">
            <Link
              to="/profile"
              className="inline-flex items-center gap-1 px-2.5 py-1.5 text-xs font-medium text-slate-700 hover:text-slate-900 bg-slate-100 hover:bg-slate-200 rounded border border-slate-200"
            >
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden border-t border-slate-200 bg-white px-4 pt-3 pb-6 space-y-4 max-h-[85vh] overflow-y-auto">
          <div className="space-y-1">
            ...
            <Link
              to="/profile"
              className="flex items-center gap-2 px-3 py-2 text-sm font-medium text-slate-800 hover:bg-slate-50 rounded-md"
            >
              <User className="w-4 h-4 text-blue-600" />
              <span>Profile (CEO - Syed Abdul Matheen)</span>
            </Link>
            <Link
              to="/contact"
              className="block px-3 py-2 text-sm font-medium text-slate-800 hover:bg-slate-50 rounded-md"
